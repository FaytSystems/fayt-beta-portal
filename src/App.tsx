  ...
  return (
    <main className="site">
      ...
      <section className="hero">
        <div>
          <p className="eyebrow">Fayt Systems / Verified Beta Access</p>
        ...
        <aside className="heroAside">
          <span>Public demo remains separate</span>
          <strong>Live Coinbase Advanced market data with simulated paper execution.</strong>
          <small>Real-money beta setup is handled here, not on demo.faytsystems.com.</small>
        </aside>
      </section>

      {step === "signup" ? (
        <form className="panel" onSubmit={signup}>
          <p className="eyebrow">Free 30-Day Real-Money Beta</p>
          <h2>Verify your email before beta dashboard access.</h2>
      ...
      {step === "verify" ? (
        <form className="panel" onSubmit={verify}>
          ...
          <p className="lede">A code was sent to {email}.</p>
      ...
      <footer className="footer">
        ...
        <p>The beta portal never asks users to upload Coinbase API secrets.</p>
      </footer>
    </main>
  );
}
